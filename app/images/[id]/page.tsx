    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto flex max-w-5xl flex-col gap-8 px-6 py-12 sm:px-10">
        <div className="rounded-[32px] border border-slate-800 bg-slate-900/95 p-10 shadow-[0_30px_60px_rgba(15,23,42,0.7)]">
          <h1 className="text-4xl font-semibold">Görsel Arkaplan</h1>
          <p className="mt-4 text-slate-300">Seçilen görsel ID: <span className="font-medium text-cyan-300">{params.id}</span></p>
          <div className="mt-8 rounded-3xl border border-slate-800 bg-slate-800/80 p-6">
            <p className="text-sm text-slate-400">Bu sayfa, bir görsel arkaplanı veya görsel temayı temsil edecek.</p>
          </div>
          <div className="mt-8">
